...
10 rows in set (0.0484 sec)
   MySQL  localhost:33060+ ssl  dbms_assignment  SQL > SELECT first_name,last_name,salery,salery*15/100 AS PF from employees;
ERROR: 1054: Unknown column 'salery' in 'field list'
 MySQL  localhost:33060+ ssl  dbms_assignment  SQL > SELECT firt_name , last_name , salary ,salary *15/100 AS PF FROM employyes;
ERROR: 1146: Table 'dbms_assignment.employyes' doesn't exist
 MySQL  localhost:33060+ ssl  dbms_assignment  SQL > SELECT firt_name , last_name , salary ,salary *15/100 AS PF FROM employees;
ERROR: 1054: Unknown column 'firt_name' in 'field list'
 MySQL  localhost:33060+ ssl  dbms_assignment  SQL > SELECT first_name , last_name , salary ,salary *15/100 AS PF FROM employees;
+------------+-----------+----------+-------------+
| first_name | last_name | salary   | PF          |
+------------+-----------+----------+-------------+
| Rahul      | Sharma    | 30000.00 | 4500.000000 |
| Priya      | Verma     | 35000.00 | 5250.000000 |
| Aman       | Patel     | 28000.00 | 4200.000000 |
| Neha       | Singh     | 40000.00 | 6000.000000 |
| Riya       | Gupta     | 32000.00 | 4800.000000 |
| Karan      | Mehta     | 45000.00 | 6750.000000 |
| Ankit      | Jain      | 25000.00 | 3750.000000 |
| Pooja      | Yadav     | 38000.00 | 5700.000000 |
| Vikas      | Shah      | 50000.00 | 7500.000000 |
| Simran     | Khan      | 42000.00 | 6300.000000 |
+------------+-----------+----------+-------------+
10 rows in set (0.0038 sec)
