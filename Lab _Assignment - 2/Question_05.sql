...
10 rows in set (0.0484 sec)
   MySQL  localhost:33060+ ssl  dbms_assignment  SQL > select employee_id,first_name,last_name,salary FROM employees ORDER BY salary ASC;
+-------------+------------+-----------+----------+
| employee_id | first_name | last_name | salary   |
+-------------+------------+-----------+----------+
|           7 | Ankit      | Jain      | 25000.00 |
|           3 | Aman       | Patel     | 28000.00 |
|           1 | Rahul      | Sharma    | 30000.00 |
|           5 | Riya       | Gupta     | 32000.00 |
|           2 | Priya      | Verma     | 35000.00 |
|           8 | Pooja      | Yadav     | 38000.00 |
|           4 | Neha       | Singh     | 40000.00 |
|          10 | Simran     | Khan      | 42000.00 |
|           6 | Karan      | Mehta     | 45000.00 |
|           9 | Vikas      | Shah      | 50000.00 |
+-------------+------------+-----------+----------+
