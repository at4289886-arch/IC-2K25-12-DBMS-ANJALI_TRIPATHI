 MySQL  localhost:33060+ ssl  SQL > ude dbms_assignment;
ERROR: 1064: You have an error in your SQL syntax; check the manual that corresponds to your MySQL server version for the right syntax to use near 'ude dbms_assignment' at line 1
...
10 rows in set (0.0014 sec)
 MySQL  localhost:33060+ ssl  dbms_assignment  SQL > SELECT AVG(salary) AS average_salary,
